...
| 9 | Voice | **D-032 (2026-05-22)**: 3 ElevenLabs Creator-tier voices by tier role — `ELEVENLABS_VOICE_ID_BRIEF` (tier 1+2), `ELEVENLABS_VOICE_ID_PODCAST` (tier 3), `ELEVENLABS_VOICE_ID_CONFERENCE` (tier 4+5). **Jellypod failover** (`JELLYPOD_FAILOVER_HOST_ID`, ADR-0018 — supersedes dead PlayHT). Tier-3 podcast generated via Jellypod (D-POD-1). Kimal voice clone deferred post-launch. | Audio Architecture v1.0 §2.1 + D-032 + ADR-0018 + D-POD-1 |
...
| TTS | ElevenLabs primary (single-narrator) + Jellypod (Tier-3 podcast + failover) | ADR-0004 + ADR-0018 + D-POD-1 |
