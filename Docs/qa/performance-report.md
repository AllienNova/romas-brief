...
| NFR-006 | Schema CHECK constraints 100% covered by pgTAP | cms-engineer | YES — A-013..A-019. Cycle-1 critic F-P2-05 flagged enum-CHECK coverage missing (archetype/tier/status enums, claims.confidence, qa_reviewers.role, audio_jobs.audio_tier per ADR-0017, title length). Cycle build-2026-05-21 adds further constraints — see remediation-plan R-105 extension. | **P2 — coverage gap from cycle-1 + build-2026-05-21 unfixed; owned by R-105** |
